...
class EditorPostUpload extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    editorPostUpload = () => {
        const url = '/api/editorPostUpload';
            ...
            <div className={classes.root}>
                ...
                <Dialog open={this.state.open} onClose={this.handleClickClose}>
                    ...
                    <DialogContent>
                        ...
                        <RadioGroup row aria-label="position" name="position" defaultValue="true" onChange={this.handleRadioChange}>
                            <FormControlLabel
                                value="true"
...
export default withStyles(styles)(EditorPostUpload);